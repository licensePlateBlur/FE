...
const SwitchLayer : React.FC<SwitchProps> = ({
    change,
    ChangeHandler
}) =>{
    ...
    return(
    <ButtonLayer>
        <ListLayer onClick={ChangeHandler}>
            {change ? <Darklist/> : <Whitelist/>}
        </ListLayer>
        <GridLayer onClick={ChangeHandler}>
            {change ? <Whitegrid/> : <Darkgrid/>}
        </GridLayer>
    </ButtonLayer>)
}
